...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="bridge2.css">
	</head>
 <div class="header">
    <div class="wrap">
  <div class="logoH">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
					<h2> <center>Sanchez<font color="#b666d2"> Dental</font> Care</center></h2>
					<br>
				<center><h2><font color="#b666d2"> Admin Login</font></h2></center>
				</div>
