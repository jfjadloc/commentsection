...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="userbridge.css">
  </head>
 <div class="header">
   ...
   <ul>
  <li><a href="http://localhost/commentsection/index.php">Home</a></li>
          <li><a href="http://localhost/commentsection/AboutUs.php">About </a></li>
           ...
           <li><a href="http://localhost/commentsection/Office.php">Office</a></li>
                  ...
                  <li><a href="http://localhost/commentsection/testimonial.php">Testimonial</a></li>
...
<div class="logoH4">
  ...
  <body class="login">
    <div class="row">
      ...
      <center>  <a href="../index.html"><h2> Sanchez<font color="#b666d2"> Dental</font> Care</h2></a> </center>
      <br><br> <center><h2>Patient Login</h2></center>
        </div>
