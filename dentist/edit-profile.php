...
<html lang="en">
	<head>
		<title>Doctr | Edit Dentist Details</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><font color="#b666d2"> Dentist | Edit Dentist Details </font></h1>
																	</div>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Dentist</h5>
												</div>
